  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 to-gray-700 text-white">
      <Head>
        ...
        <meta
          name="description"
          content="Pact helps to make impactful decisions out of group discussions."
        />
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-4 md:px-20 text-center">
        <div className="relative mb-6">
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-purple-600 rounded-full blur-lg opacity-75">
          </div>
          <Image
            src="/icon.png"
            alt="Pact Logo"
        ...
        <p className="mt-3 text-lg max-w-xl">
          Pact simplifies teamwork by turning chaotic discussions into
          organized, actionable plans. Our thread-based format helps you focus
          on what matters and make better decisions together.
        </p>
        <div className="mt-10 flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
          <a
            href="https://play.google.com/store/apps/details?id=com.xooniverse.pact"
            target="_blank"
          ...
          <a
            href="https://apps.apple.com/us/app/pact-make-informed-decisions/id6578456063?platform=iphone"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className="flex items-center bg-white text-blue-600 px-6 py-3 rounded-lg shadow-lg hover:bg-gray-200">
